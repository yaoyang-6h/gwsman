...
${OBJECTDIR}/src/art_tool.o: src/art_tool.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCONFIG_LIBNL20 -Iinclude -Isrc/libiwinfo/include -I../../build_dir/target-mips_r2_uClibc-0.9.33.2/libnl-2.0/include -I../../build_dir/target-mips_r2_uClibc-0.9.33.2/lua-5.1.4/ipkg-install/usr/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/art_tool.o src/art_tool.c
